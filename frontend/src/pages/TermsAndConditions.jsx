      ...
      <div className="tc-header">
        <div className="tc-header-inner">
          <div className="tc-header-top">
            ...
            <button className="tc-brand" onClick={() => navigate('/')}>Lemmatica.</button>
          </div>
          ...
          <p className="tc-meta-sub">
            Plataforma operada por <strong>Lemma Sistemas Inteligentes S.A. de C.V.</strong> bajo la marca <strong>Lemmatica</strong> — Estados Unidos Mexicanos.
          </p>
        </div>
      </div>
      ...
      <div className="tc-content">
          ...
          {activeTab === 'privacy' && (
            <motion.div key="privacy" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.2 }}>
              ...
              <Section icon={UserCheck} tone="green" title="Tus Derechos ARCO">
                <p className="tc-sub-label" style={{ marginTop: 0 }}>Como titular de datos personales, tienes los siguientes derechos ejercibles ante Lemmatica: Acceso, Rectificación, Cancelación y Oposición (ARCO).</p>
          ...
          {activeTab === 'legal' && (
            <motion.div key="legal" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.2 }}>
              <div className="tc-alert tc-alert-violet">
                ...
                <p>Esta sección describe cómo operamos la infraestructura del servicio, los límites de responsabilidad económica y las condiciones de propiedad intelectual aplicables a Lemmatica.</p>
              </div>
              ...
              <Section icon={Shield} tone="gold" title="Limitación General de Responsabilidad">
                <p className="tc-sub-label" style={{ marginTop: 0 }}>Lemmatica no será responsable por:</p>
              ...
              <Section icon={Mail} tone="green" title="Jurisdicción y Ley Aplicable">
                <p>Los presentes Términos se rigen por las leyes de los <strong>Estados Unidos Mexicanos</strong>. Para la resolución de controversias, las partes se someten expresamente a la jurisdicción de los tribunales competentes de <strong>Toluca, Estado de México, o de la Ciudad de México</strong>, renunciando a cualquier otro fuero que pudiera corresponderles por razón de sus domicilios presentes o futuros. Contacto legal: <strong>legal@lemmatica.com.mx</strong>.</p>
              </Section>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="tc-contact">
          ...
          <div className="tc-contact-actions">
            <a href="mailto:privacidad@lemmatica.com.mx" className="tc-contact-link tc-contact-link-fill">
              <Mail size={16} /> privacidad@lemmatica.com.mx
            </a>
            <a href="mailto:legal@lemmatica.com.mx" className="tc-contact-link tc-contact-link-outline">
              <Shield size={16} /> legal@lemmatica.com.mx
            </a>
          </div>
          <p className="tc-contact-foot">
            Lemma Sistemas Inteligentes S.A. de C.V. · Marca Lemmatica · Estados Unidos Mexicanos · Lemmatica © 2026
          </p>
        </div>
      </div>
    </div>
