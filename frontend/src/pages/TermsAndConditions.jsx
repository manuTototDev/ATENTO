      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 5%' }}>
        ...
        {activeTab === 'legal' && (
          <>
            ...
            <Section icon={Mail} title="Jurisdicción y Ley Aplicable">
        ...
        <div style={{ backgroundColor: '#000', color: '#fff', borderRadius: '16px', padding: '3rem', textAlign: 'center', marginTop: '2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="mailto:privacidad@lemmatica.com.mx" style={{ backgroundColor: '#fff', color: '#000', padding: '0.75rem 1.5rem', borderRadius: '100px', fontWeight: 600, fontSize: '0.9rem', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              <Mail size={16} /> privacidad@lemmatica.com.mx
            </a>
            <a href="mailto:legal@lemmatica.com.mx" style={{ backgroundColor: 'transparent', color: '#fff', padding: '0.75rem 1.5rem', borderRadius: '100px', fontWeight: 600, fontSize: '0.9rem', textDecoration: 'none', border: '1px solid #444', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
